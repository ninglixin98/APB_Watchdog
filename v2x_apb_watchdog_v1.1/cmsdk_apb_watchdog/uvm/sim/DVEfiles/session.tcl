...
# DVE full session
# Saved on Fri Jun 3 17:01:24 2022
# Designs open: 1
...
gui_show_window -window ${CovTopLevel.1} -show_state maximized -rect {{2 76} {3635 1800}}
...
set CovHier.1 [gui_create_window -type CovHier -parent ${CovTopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 1186]
gui_set_window_pref_key -window ${CovHier.1} -key dock_width -value_type integer -value 1186
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 1185} {height 1390} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 1050} {child_covhier_coltype 126} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 3633} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_covtable_show -id CoverageTable.1 -show {Function Groups}  -cumulative 1
catch {gui_list_expand -id ${CoverageTable.1} {/<Function Groups>}}
catch {gui_list_select -id ${CoverageTable.1} {{/<Function Groups>/apb_if::cg_apb_command}}}
