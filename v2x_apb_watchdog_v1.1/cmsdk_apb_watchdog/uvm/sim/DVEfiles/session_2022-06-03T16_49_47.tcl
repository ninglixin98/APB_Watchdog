...
# DVE full session
# Saved on Fri Jun 3 16:49:47 2022
# Designs open: 1
...
set CovHier.1 [gui_create_window -type CovHier -parent ${CovTopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 1522]
gui_set_window_pref_key -window ${CovHier.1} -key dock_width -value_type integer -value 1522
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 1521} {height 1618} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 1386} {child_covhier_coltype 126} {child_covhier_col1 1} {child_covhier_col2 2}}
...
catch {gui_list_select -id ${CovHier.1} {{/<Function Groups>}}}
...
gui_open_source -id ${CovDetail.1}  -replace -active rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cgMergedTest -type {Cover Group}  /home/verifier/project/rkv_labs/v2x_addon/cmsdk_apb_watchdog/uvm/sim/../cov/rkv_watchdog_cov.sv
gui_src_value_annotate -id ${CovDetail.1} -switch true
gui_set_env TOGGLE::VALUEANNOTATE 1
gui_view_scroll -id ${CovDetail.1} -vertical -set 2376
gui_src_set_reusable -id ${CovDetail.1}
gui_cov_populate_fun -id CovDetail.1 -name {rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cgMergedTest} -type {Cover Group}
...
gui_covdetail_select -id CovDetail.1 -test MergedTest
gui_list_expand -id CovDetail.1  /rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cg
gui_list_expand -id CovDetail.1  /rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cg/rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cg
gui_list_expand -id CovDetail.1  /rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cg/rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cg
catch { gui_list_select -id CovDetail.1  -list {covergroup}  {rkv_watchdog_pkg::rkv_watchdog_cov::rkv_wdg_t2_load_reload_cg.RELOAD}}
gui_covdetail_select -id CovDetail.1 -name Covergroup
