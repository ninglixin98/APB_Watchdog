...
# DVE full session
# Saved on Sun Apr 17 19:57:03 2022
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 432} {height 1470} {dock_state left} {dock_on_new_line true} {child_hier_colhier 331} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 754]
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 754
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 1469
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 753} {height 1470} {dock_state left} {dock_on_new_line true} {child_data_colvariable 295} {child_data_colvalue 253} {child_data_coltype 196} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 397]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 3780
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 397
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 3839} {height 396} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed=1 +UVM_TESTNAME=rkv_watchdog_integration_test -do rkv_watchdog_sim_run.do}}
...
gui_sim_run Ucli -exe rkv_watchdog_tb.simv -args { -a run.log +ntb_random_seed=1 +UVM_TESTNAME=rkv_watchdog_integration_test -do rkv_watchdog_sim_run.do -ucligui} -dir /home/verifier/project/rkv_labs/v2x_addon/cmsdk_apb_watchdog/uvm/sim -nosource
}
}
...
catch {gui_list_expand -id ${Hier.1} rkv_watchdog_tb}
catch {gui_list_select -id ${Hier.1} {rkv_watchdog_tb.apb_if_inst}}
...
gui_list_show_data -id ${Data.1} {rkv_watchdog_tb.apb_if_inst}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {rkv_watchdog_tb.apb_if_inst.paddr }}
...
gui_view_scroll -id ${Source.1} -vertical -set 3760
