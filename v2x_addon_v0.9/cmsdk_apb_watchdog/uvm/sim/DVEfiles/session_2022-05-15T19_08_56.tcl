...
# DVE full session
# Saved on Sun May 15 19:08:56 2022
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 1115} {child_wave_right 2719} {child_wave_colname 570} {child_wave_colvalue 540} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed=1 +UVM_TESTNAME=rkv_watchdog_reload_test -do rkv_watchdog_sim_run.do}}
...
gui_sim_run Ucli -exe rkv_watchdog_tb.simv -args { -a run.log +ntb_random_seed=1 +UVM_TESTNAME=rkv_watchdog_reload_test -do rkv_watchdog_sim_run.do -ucligui} -dir /home/verifier/project/rkv_labs/v2x_addon/cmsdk_apb_watchdog/uvm/sim -nosource
}
}
...
gui_wv_zoom_timerange -id ${Wave.1} 29569919 29580077
...
gui_marker_move -id ${Wave.1} {C1} 29575000
