...
# DVE full session
# Saved on Fri May 6 14:41:30 2022
# Designs open: 1
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed=1 +UVM_TESTNAME=rkv_watchdog_apbacc_test -do rkv_watchdog_sim_run.do}}
...
gui_sim_run Ucli -exe rkv_watchdog_tb.simv -args { -a run.log +ntb_random_seed=1 +UVM_TESTNAME=rkv_watchdog_apbacc_test -do rkv_watchdog_sim_run.do -ucligui} -dir /home/verifier/project/rkv_labs/v2x_addon/cmsdk_apb_watchdog/uvm/sim -nosource
}
}
